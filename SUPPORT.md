...
Thanks for using mupet! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/astamm/mupet/issues/new).
...
requests](https://github.com/astamm/mupet/issues) to make sure the bug
