...
This outlines how to propose a change to mupet. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("astamm/mupet", fork = TRUE)`.
...
Please note that the mupet project is released with a [Contributor Code
of Conduct](https://astamm.github.io/mupet/CODE_OF_CONDUCT.md). By
